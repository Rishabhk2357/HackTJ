...
const compiledContract = require("./ForwardExample.json"); // get compiled bytecode and ABI (interface)
...
const provider = new HDWalletProvider(
  "mesh host noise bronze tumble daughter ribbon slogan liar cereal achieve best", //mnemonic generates many accounts
  "https://rinkeby.infura.io/WE9YJajMBeNUkvZbElZO " //provider url with access key
);
